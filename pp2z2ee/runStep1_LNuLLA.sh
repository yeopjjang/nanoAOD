...
GridPack=${TopDir}/test_slc6_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz
...
# with command line options: Configuration/GenProduction/python/LNuLLA-RunIIFall18wmLHEGS-fragment.py --fileout file:LNuLLA-RunIIFall18wmLHEGS-test.root --python_filename LNuLLA-RunIIFall18wmLHEGS-test_cfg.py --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2018 --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(60) -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/LNuLLA-RunIIFall18wmLHEGS-fragment.py nevts:${MaxEvents}'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:${s1root}'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:${s1LHEroot}'),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(60)
